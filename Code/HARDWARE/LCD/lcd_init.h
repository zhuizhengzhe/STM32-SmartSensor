...
#define LCD_CS_Clr()   GPIO_ResetBits(GPIOB,GPIO_Pin_12)//CS1
...
#define ZK_MISO        GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_7)//MISO  读取字库数据引脚

#define ZK_CS_Clr()    GPIO_ResetBits(GPIOB,GPIO_Pin_8)//CS2 字库片选
#define ZK_CS_Set()    GPIO_SetBits(GPIOB,GPIO_Pin_8)		
