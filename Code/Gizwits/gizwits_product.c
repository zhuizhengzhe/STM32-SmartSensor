  ...
  for(i=0; i<info->num; i++)
  {
    switch(info->event[i])
    {
      ...
      case EVENT_Switch5:
        ...
        break;
      case EVENT_Switch6:
        currentDataPoint.valueSwitch6 = dataPointPtr->valueSwitch6;
        GIZWITS_LOG("Evt: EVENT_Switch6 %d \n", currentDataPoint.valueSwitch6);
        if(0x01 == currentDataPoint.valueSwitch6)
        {
          //user handle
        }
        else
        ...
        break;
      case EVENT_Switch7:
        currentDataPoint.valueSwitch7 = dataPointPtr->valueSwitch7;
        GIZWITS_LOG("Evt: EVENT_Switch7 %d \n", currentDataPoint.valueSwitch7);
        if(0x01 == currentDataPoint.valueSwitch7)
        {
          //user handle
        }
        else
...
//{
 /*
    currentDataPoint.valueGas_Concentration = ;//Add Sensor Data Collection
    currentDataPoint.valueInput_Voltage = ;//Add Sensor Data Collection
    currentDataPoint.valueCollection_Voltage = ;//Add Sensor Data Collection
...
void userInit(void)
{
    ...
    /*
      ...
      currentDataPoint.valueSwitch6 = ;
      currentDataPoint.valueSwitch7 = ;
      currentDataPoint.valueGas_Concentration = ;
      currentDataPoint.valueInput_Voltage = ;
      currentDataPoint.valueCollection_Voltage = ;
    */
