...
* @{
*/
#define PRODUCT_KEY "730275e015bf4ca5bf4705585a62a0b1"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "c04bc70909c34d2e9ac04b3a3693226f"
...
* @{
*/
#define Switch1_BYTEOFFSET                    0
#define Switch1_BITOFFSET                     0
#define Switch1_LEN                           1
#define Switch2_BYTEOFFSET                    0
#define Switch2_BITOFFSET                     1
#define Switch2_LEN                           1
#define Switch3_BYTEOFFSET                    0
#define Switch3_BITOFFSET                     2
#define Switch3_LEN                           1
#define Switch4_BYTEOFFSET                    0
#define Switch4_BITOFFSET                     3
#define Switch4_LEN                           1
#define Switch5_BYTEOFFSET                    0
#define Switch5_BITOFFSET                     4
#define Switch5_LEN                           1
#define Switch6_BYTEOFFSET                    0
#define Switch6_BITOFFSET                     5
#define Switch6_LEN                           1
#define Switch7_BYTEOFFSET                    0
#define Switch7_BITOFFSET                     6
#define Switch7_LEN                           1

#define Gas_Concentration_RATIO                         1
#define Gas_Concentration_ADDITION                      1
#define Gas_Concentration_MIN                           0
#define Gas_Concentration_MAX                           99
#define Input_Voltage_RATIO                         0.001
#define Input_Voltage_ADDITION                      1
#define Input_Voltage_MIN                           0
#define Input_Voltage_MAX                           4000
#define Collection_Voltage_RATIO                         0.001
#define Collection_Voltage_ADDITION                      1
#define Collection_Voltage_MIN                           0
#define Collection_Voltage_MAX                           4000
/**@} */
...
typedef struct {
  ...
  bool valueSwitch6;
  bool valueSwitch7;
  uint32_t valueGas_Concentration;
  float valueInput_Voltage;
  float valueCollection_Voltage;
} dataPoint_t;
...
typedef struct {
  ...
  uint8_t flagSwitch6:1;
  uint8_t flagSwitch7:1;
} attrFlags_t;
...
typedef struct {
  uint8_t wBitBuf[COUNT_W_BIT];
  uint8_t valueGas_Concentration;
  uint16_t valueInput_Voltage;
  uint16_t valueCollection_Voltage;
} devStatus_t; 
